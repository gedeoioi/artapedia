...
@php
    ...
    $faqs = [
        ...
        ['Berapa lama pesanan diproses?', 'Sebagian besar pesanan diproses otomatis dalam beberapa menit setelah pembayaran terkonfirmasi. Waktu dapat lebih lama apabila bank, penyedia pembayaran, atau operator sedang mengalami gangguan.'],
        ...
        ['Apa yang harus dilakukan jika produk belum masuk?', 'Periksa kembali data tujuan dan status invoice. Jika transaksi sudah sukses tetapi produk belum diterima, hubungi dukungan agar kami dapat menelusuri serial number atau status pengiriman pesanan Anda.'],
